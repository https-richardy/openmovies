...
public sealed class MovieCreationValidatorTest
{
    private readonly IValidator<MovieCreationRequest> _validator;

    public MovieCreationValidatorTest()
    {
        _validator = new MovieCreationValidator();
    }
    ...
    {
        var payload = new MovieCreationRequest
        {
            Title = string.Empty,
